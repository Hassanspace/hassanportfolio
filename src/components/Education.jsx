  ...
  return (
    <VerticalTimeline>
      ...
      <VerticalTimelineElement
        ...
        icon={
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxxHTRvmtwridFwczlz01h7_gxM7mI1Eu0mA&s"
            alt="DPS Logo"
            className="rounded-full h-full w-full"
          />
        }
      ...
      <VerticalTimelineElement
        ...
        icon={
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVWJ9FR4TIBknBIRIUtkcjYSJHQkN0HRjrfg&s"
      ...
      <VerticalTimelineElement
        ...
        icon={<img
            src="https://png.pngtree.com/element_our/20190529/ourmid/pngtree-finish-icon-image_1198540.jpg"
            alt="The Educators Logo"
            className="rounded-full h-full w-full"
          />}
      />
